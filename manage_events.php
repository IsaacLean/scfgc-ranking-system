            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                foreach($events as $event) {
                  ...
                  echo "<td><a href=\"/edit_event.php?season_id=" . $event["id"] . "\"><button type=\"button\" class=\"btn btn-default\">Edit</button></a></td>";
                  echo "<td><a href=\"/view_event.php?season_id=" . $event["id"] . "\"><button type=\"button\" class=\"btn btn-default\">View</button></a></td>";
                  echo "</tr>";
                }
                ?>
              </tbody>
